...
window.app = {
	...
	html:[
		{"id":"wrapper"},[
			...
			">- (https://ucnv.org/turpentine/turpentine.pdf, ucnv『turpentine』)",
			"rdm03は正しくデータモッシュをする。",
			"rdm03.jpg",
			[
			...
			"旧バージョンの(https://twitter.com/mizt_org/status/1245484754964643840,rdm)/rdm02は(https://github.com/xiph/theora,libtheora)に依存した実装である。\nフレーム内でエンコードして、デコードを行う。デコード結果がキーフレームであった場合には、複合を行わない。（ここではlibtheoraによるエンコード／デコードの処理は忠実に実行されている）",
